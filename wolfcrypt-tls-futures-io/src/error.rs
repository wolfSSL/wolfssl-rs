// Async-specific error types for wolfcrypt-tls-futures-io.
// Identical in structure to wolfcrypt-tls-tokio::error — wraps TlsError
// and io::Error.  Kept separate so the two crates have no cross-dependency.
