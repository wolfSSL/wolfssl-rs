...
impl BLAKE2b {
    ...
    ///
    /// ```rust
    /// use wolfcrypt_wrapper::blake2::BLAKE2b;
...
impl BLAKE2bHmac {
    ...
    ///
    /// ```rust
    /// use wolfcrypt_wrapper::blake2::BLAKE2bHmac;
    /// let key = [42u8, 43, 44];
...
impl BLAKE2s {
    ...
    ///
    /// ```rust
    /// use wolfcrypt_wrapper::blake2::BLAKE2s;
...
impl BLAKE2sHmac {
    ...
    ///
    /// ```rust
    /// use wolfcrypt_wrapper::blake2::BLAKE2sHmac;
    /// let key = [42u8, 43, 44];
