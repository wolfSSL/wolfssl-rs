...
/// {
/// use wolfcrypt_wrapper::kdf::pbkdf2;
...
/// #[cfg(all(hmac, kdf_pbkdf2))]
/// {
/// use wolfcrypt_wrapper::kdf::pbkdf2_ex;
/// use wolfcrypt_wrapper::hmac::HMAC;
/// let password = b"passwordpassword";
/// let salt = [0x78u8, 0x57, 0x8E, 0x5a, 0x5d, 0x63, 0xcb, 0x06];
/// let iterations = 2048;
...
/// {
/// use wolfcrypt_wrapper::kdf::pkcs12_pbkdf;
/// use wolfcrypt_wrapper::hmac::HMAC;
...
/// #[cfg(all(hmac, kdf_pkcs12))]
/// {
/// use wolfcrypt_wrapper::kdf::pkcs12_pbkdf_ex;
/// use wolfcrypt_wrapper::hmac::HMAC;
/// let password = [0x00u8, 0x73, 0x00, 0x6d, 0x00, 0x65, 0x00, 0x67, 0x00, 0x00];
/// let salt = [0x0au8, 0x58, 0xCF, 0x64, 0x53, 0x0d, 0x82, 0x3f];
/// let expected_key = [
...
pub fn tls13_hkdf_expand_label_ex(
    typ: i32,
    key: &[u8],
    protocol: &[u8],
    label: &[u8],
    ...
    let rc = unsafe {
        sys::wc_Tls13_HKDF_Expand_Label_ex(
            out.as_mut_ptr(),
            out_size,
            key.as_ptr(),
            key_size,
