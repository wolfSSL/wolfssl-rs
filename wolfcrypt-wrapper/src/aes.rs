...
/// #[cfg(aes_gcm_stream)]
/// {
/// use wolfcrypt_wrapper::aes::GCMStream;
/// let plain: [u8; 60] = [
...
/// #[cfg(aes_xts_stream)]
/// {
/// use wolfcrypt_wrapper::aes::XTSStream;
/// let keys: [u8; 32] = [
