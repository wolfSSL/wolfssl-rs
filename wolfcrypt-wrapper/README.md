# wolfcrypt-wrapper crate

The `wolfcrypt-wrapper` crate is a Rust wrapper for the wolfCrypt cryptographic
...
The `wolfcrypt-wrapper` crate can be used by including it as a dependency in
