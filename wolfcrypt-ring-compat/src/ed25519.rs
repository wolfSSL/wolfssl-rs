...
use crate::wolfcrypt_rs::{EVP_PKEY, EVP_PKEY_ED25519};
...
pub const ED25519_PUBLIC_KEY_LEN: usize = crate::wolfcrypt_rs::ED25519_PUBLIC_KEY_LEN as usize;
const ED25519_SIGNATURE_LEN: usize = crate::wolfcrypt_rs::ED25519_SIGNATURE_LEN as usize;
...
impl Ed25519KeyPair {
    ...
    /// The wolfcrypt-ring implementation produces PKCS#8 v2 encoded documents that are compliant per
    ...
    pub fn sign(&self, msg: &[u8]) -> Signature {
        // PANIC-SAFETY: Documented panic; use try_sign for fallible variant
