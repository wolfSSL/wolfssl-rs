...
//! Run with:
//!    `WOLFCRYPT_RING_DEV_TESTS_ONLY=1 cargo test --test unsealed_rand_test`
//! OR:
...
use ring::rand::{unsealed, SecureRandom};
...
// Implement the unsealed::SecureRandom trait. The blanket impl in wolfcrypt-ring
