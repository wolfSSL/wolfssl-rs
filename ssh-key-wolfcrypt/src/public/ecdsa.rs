...
// p256/p384/p521 crate conversion impls removed — wolfcrypt is now the
// sole cryptographic backend.  Public keys are stored as SEC1-encoded
// `EncodedPoint` byte arrays and handed directly to wolfcrypt's
// `ecc::EccKey::from_public_x963()` when needed.
