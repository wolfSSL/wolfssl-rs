...
#[cfg(feature = "p384")]
const ECDSA_P384_PRIVATE_KEY: &str = include_str!("examples/id_ecdsa_p384");

/// ECDSA/P-384 OpenSSH-formatted public key.
#[cfg(feature = "p384")]
const ECDSA_P384_PUBLIC_KEY: &str = include_str!("examples/id_ecdsa_p384.pub");

/// ECDSA/P-521 OpenSSH-formatted private key.
#[cfg(feature = "p521")]
const ECDSA_P521_PRIVATE_KEY: &str = include_str!("examples/id_ecdsa_p521");

/// ECDSA/P-521 OpenSSH-formatted public key.
#[cfg(feature = "p521")]
const ECDSA_P521_PUBLIC_KEY: &str = include_str!("examples/id_ecdsa_p521.pub");
...
#[cfg(feature = "p384")]
fn sign_ecdsa_p384() {
    let signing_key = PrivateKey::from_openssh(ECDSA_P384_PRIVATE_KEY).unwrap();
    let verifying_key = ECDSA_P384_PUBLIC_KEY.parse::<PublicKey>().unwrap();
...
#[cfg(feature = "p521")]
fn sign_ecdsa_p521() {
    let signing_key = PrivateKey::from_openssh(ECDSA_P521_PRIVATE_KEY).unwrap();
    let verifying_key = ECDSA_P521_PUBLIC_KEY.parse::<PublicKey>().unwrap();
