...
fn rsa2048_pkcs1_openssl_interop() {
    const PKCS8_PRIVATE_KEY: &[u8] =
        include_bytes!("../../wolfcrypt-ring-compat/tests/data/rsa_test_private_key_2048.p8");
    const RSA_PRIVATE_KEY: &[u8] =
        include_bytes!("../../wolfcrypt-ring-compat/tests/data/rsa_test_private_key_2048.der");
    const PUBLIC_KEY: &[u8] =
        include_bytes!("../../wolfcrypt-ring-compat/tests/data/rsa_test_public_key_2048.x509");
