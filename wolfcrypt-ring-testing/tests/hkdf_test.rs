use wolfcrypt_ring_compat::hkdf::{Prk, Salt, HKDF_SHA256};
...
fn rustls_test() {
    ...
    */
    ...
    println!("wolfcrypt-ring-compat Result: {output1:?}");
    println!("wolfcrypt-ring-compat Result: {output2:?}");
...
fn okm_to_salt() {
    ...
    println!("wolfcrypt-ring-compat: {output:?}");
